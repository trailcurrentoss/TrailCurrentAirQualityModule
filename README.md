...
- **[C6SuperMiniRgbLedLibrary](https://codeberg.org/trailcurrent/C6SuperMiniRgbLedLibrary)** (v0.0.1) - RGB LED status indicator driver
- **[Esp32C6OtaUpdateLibrary](https://codeberg.org/trailcurrent/Esp32C6OtaUpdateLibrary)** (v0.0.1) - Over-the-air firmware update functionality
- **[Esp32C6TwaiTaskBasedLibrary](https://codeberg.org/trailcurrent/Esp32C6TwaiTaskBasedLibrary)** (v0.0.3) - CAN bus communication interface
